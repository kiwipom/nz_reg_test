...
database_stack = DatabaseStack(app, "NzCompaniesDatabase", 
                              vpc=vpc_stack.vpc,
                              env=env)
storage_stack = StorageStack(app, "NzCompaniesStorage", env=env)

# Application infrastructure
compute_stack = ComputeStack(app, "NzCompaniesCompute",
                           vpc=vpc_stack.vpc,
...
monitoring_stack = MonitoringStack(app, "NzCompaniesMonitoring",
